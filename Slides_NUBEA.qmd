...
- No dia a dia, utilizar o R localmente é mais funcional e, para isso, você deve [instalar o R](https://posit.co/download/rstudio-desktop/) e a IDE que você tenha interesse;
- Caso seja o RStudio, você pode instalar [aqui](https://posit.co/download/rstudio-desktop/).
